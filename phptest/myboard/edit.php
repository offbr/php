...
<body topmargin=50pt leftmargin=300pt text=#464646>
	...
	<form action=update.php?id=<?="$_GET[id]"?> method=post>
		<table width=580 border=0 cellpadding=2 cellspacing=1 bgcolor=#777777>
			<tr>
				<td height=20 align=center bgcolor=#999999><font color=white><B>글 수
							정 하 기</B></font></td>
			</tr>
<?
// 데이터 베이스 연결하기
				...
				<td bgcolor=white>&nbsp;
					<table>
						...
						<tr>
							...
							<td align=left><INPUT type=password name="pass" size=8> (비밀번호가 맞아야
								수정가능)</td>
						</tr>
						<tr>
							<td width=60 align=left>제 목</td>
							<td align=left><INPUT type=text name="title" size=60
								value=<?=$row['title']?>></td>
						</tr>
						<tr>
							<td width=60 align=left>내용</td>
							<td align=left><TEXTAREA name="content" cols=65 rows=15>
